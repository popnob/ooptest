...
public class ItemRendererHD extends ItemRenderer
{
    ...
    public void renderItem(EntityLiving entityliving, ItemStack itemstack, int i)
    {
        ...
        if (itemstack.itemID < 256)
        {
            ...
            if (s.equals("/terrain.png") && Config.isMultiTexture())
            {
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, Tessellator.terrainTextures[k]);
                k = 0;
                f = 16F;
            }
            else
        ...
        else
        {
            ...
            if (s1.equals("/gui/items.png") && Config.isMultiTexture())
            {
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, Tessellator.itemTextures[k]);
                k = 0;
                f = 16F;
            }
            else
        ...
        int l = k;
        float f1 = ((float)((l % 16) * 16) + 0.0F) / f;
        float f2 = ((float)((l % 16) * 16) + 15.99F) / f;
        float f3 = ((float)((l / 16) * 16) + 0.0F) / f;
        float f4 = ((float)((l / 16) * 16) + 15.99F) / f;
        float f5 = 0.0F;
        float f6 = 0.3F;
        ...
        renderItem3D(tessellator, f2, f3, f1, f4, j);
        ...
        if (itemstack != null && itemstack.hasEffect() && i == 0)
        {
            ...
            float f10 = ((float)(System.currentTimeMillis() % 3000L) / 3000F) * 8F;
            ...
            GL11.glPushMatrix();
            GL11.glScalef(f9, f9, f9);
            f10 = ((float)(System.currentTimeMillis() % 4873L) / 4873F) * 8F;
            GL11.glTranslatef(-f10, 0.0F, 0.0F);
