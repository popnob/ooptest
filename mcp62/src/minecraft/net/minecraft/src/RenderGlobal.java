    ...
    public int sortAndRender(EntityLiving par1EntityLiving, int par2, double par3)
    {
        ...
        if (occlusionEnabled && mc.gameSettings.advancedOpengl && !mc.gameSettings.anaglyph && par2 == 0)
        {
            ...
            while (k1 < sortedWorldRenderers.length)
            {
                ...
                checkOcclusionQueryResult(int3, k1, par1EntityLiving.posX, par1EntityLiving.posY, par1EntityLiving.posZ);
                Profiler.endSection();
                GL11.glPushMatrix();
                float f = 0.0F;
                float f1 = 0.0F;
                ...
                Profiler.endStartSection("render");
                k += renderSortedRenderers(int3, k1, par2, par3);
            }
        }
        else
        {
