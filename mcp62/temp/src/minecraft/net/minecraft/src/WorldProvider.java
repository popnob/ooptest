...
public abstract class WorldProvider
{
    ...
    {
        if(field_4216_a.func_22144_v().func_46133_t() == WorldType.field_48636_c)
        {
    ...
    {
        if(field_46067_b == WorldType.field_48636_c)
        {
    ...
    {
        return field_46067_b != WorldType.field_48636_c ? 64 : 4;
    }

    public boolean func_46064_i()
    {
        return field_46067_b != WorldType.field_48636_c && !field_6478_e;
    }

    public double func_46065_j()
    {
        return field_46067_b != WorldType.field_48636_c ? 0.03125D : 1.0D;
    }
